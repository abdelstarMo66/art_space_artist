...
class _ApiService implements ApiService {
  ...
  Future<EditAuctionResponse> editAuction({
    String? id,
    required EditAuctionRequestBody editAuctionRequestBody,
    required String token,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(editAuctionRequestBody.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<EditAuctionResponse>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = EditAuctionResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<DeleteEventResponse> deleteEvent({
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<DeleteEventResponse>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = DeleteEventResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<EditEventResponse> editEvent({
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(editEventRequestBody.toJson());
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<EditEventResponse>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = EditEventResponse.fromJson(_result.data!);
    return value;
  }
